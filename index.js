...
function showMeme() {
  ...
  const memeplace = document.querySelector(".meme");
  const image = document.createElement("img");
  image.setAttribute("src", randomMemeUrl);
  clearAll();
  memeplace.appendChild(image);
}
...
function showJoke() {
  ...
  const place = document.querySelector(".joke-content");
  const neww = document.createElement("p");
  neww.textContent = randomJokeText;
  clearAll();
  place.appendChild(neww);
}
...
function showQuote() {
  ...
  const plac = document.querySelector(".quote-content");
  const newj = document.createElement("p");
  const newa = document.createElement("p");
  newj.textContent = randomQuote.quote;
  newa.textContent = "- " + randomQuote.author;

  clearAll();
  plac.appendChild(newj);
  plac.appendChild(newa);
}
